...
export async function pgGetAdminData(
  ...
  const [
    ...
    want.has("posters")
      ? sql`
      SELECT p.*, u.name AS owner_name, u.province AS owner_province, u.city AS owner_city, u.region AS owner_region, u.company_type AS owner_company_type
      FROM posters p
    ...
    want.has("videos")
      ? sql`
      SELECT v.*, u.name AS owner_name, u.province AS owner_province, u.city AS owner_city, u.region AS owner_region, u.company_type AS owner_company_type
      FROM videos v
    ...
    want.has("analytics")
      ? sql`
      SELECT a.*, u.name AS owner_name, u.province AS owner_province, u.city AS owner_city, u.region AS owner_region, u.company_type AS owner_company_type
    ...
    want.has("submissions")
      ? sql`
      SELECT s.*, u.name AS owner_name, u.province AS owner_province, u.city AS owner_city, u.region AS owner_region, u.company_type AS owner_company_type
    ...
    want.has("files")
      ? sql`
      SELECT f.*, u.name AS owner_name, u.province AS owner_province, u.city AS owner_city, u.region AS owner_region, u.company_type AS owner_company_type
    ...
    want.has("rawMedia")
      ? sql`
      SELECT r.*, u.name AS owner_name, u.province AS owner_province, u.city AS owner_city, u.region AS owner_region, u.company_type AS owner_company_type
